...
import { slides } from '../data/jamesEarlRay';
...
export default function JamesEarlRayVideo() {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#000' }}>
      <Audio src={staticFile('audio/james-earl-ray-arrested-1968-voiceover.mp3')} />
      <Audio
        src={staticFile('audio/hiss-music.mp3')}
        volume={0.15}
      />
