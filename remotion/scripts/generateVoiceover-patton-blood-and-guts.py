...
LINES = [
    ("01", "They called him blood and guts. A name for a fearless general."),
    ("02", "His own soldiers had a darker version. Our blood. His guts."),
    ("03", "Patton's army moved faster than almost anyone else in Europe, which meant the war ended faster too. Speed cost lives in the moment. Caution cost more over time."),
]
...
def main() -> None:
    print("=== Kokoro TTS — patton-blood-and-guts voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"patton-blood-and-guts-vo-{num}.mp3"
