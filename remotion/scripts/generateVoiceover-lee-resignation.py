...
LINES = [
    ("01-hook", "Robert E Lee called secession nothing but revolution. Then he became a Confederate general."),
    ("02-offer", "After Virginia voted to secede, but before Lee resigned, he was offered command of the Union's main army."),
    ("03-quote", "In his own letter, Lee wrote he could anticipate no greater calamity than the dissolution of the Union."),
    ("04-resignation", "He refused the offer anyway, then resigned his commission three days after Virginia voted to secede. He never returned to live at Arlington. The Union turned his home into a national cemetery."),
    ("05-endcard", "Comment CALAMITY for the free document."),
]
...
def main() -> None:
    print("=== Kokoro TTS — lee-resignation voiceovers ===\n")
    ...
    for slide, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"lee-resignation-{slide}-voiceover.mp3"
