...
LINES = [
    ("01", "Congressmen packed picnic lunches to watch this battle."),
    ("02", "By four o'clock, even senators were fleeing with the army. One escaped on a stray mule."),
    ("03", "An overturned wagon at Cub Run turned a retreat into a full rout."),
    ("04", "Only one member of Congress reached Richmond that year. As a prisoner of war."),
    ("05", "Comment BLUEGRAY for the free Civil War document."),
]
...
def main() -> None:
    print("=== Kokoro TTS — bull-run-1 voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"bull-run-1-vo-{num}.mp3"
    ...
    for num, path, sample_dur in generated:
        ...
        print(f"  bull-run-1-vo-{num}.mp3  {dur:.3f}s  ->  durationInFrames: {frames}  ({dur:.3f} + {PAD}s pad x {FPS}fps)")
