...
LINES = [
    ("hancocks-line-vo-01", "Pickett's Charge crossed three quarters of a mile. What's left out: who was waiting."),
    ("hancocks-line-vo-02", "Hancock's Second Corps held the center, the ground against which the charge was directed."),
    ("hancocks-line-vo-03", "Hancock's friend Lewis Armistead reached the Confederacy's high-water mark, then was mortally wounded."),
    ("hancocks-line-vo-04", "A bullet struck Hancock's saddle, driving wood and a bent nail into his thigh. He refused to leave while the fighting was still underway."),
    ("hancocks-line-vo-05", "He held the center. The center held."),
]
...
def main() -> None:
    print("=== Kokoro TTS -- hancocks-line voiceovers ===\n")
