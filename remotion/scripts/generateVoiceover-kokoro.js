...
const PY_SCRIPT   = path.join(__dirname, 'generateVoiceover-kokoro.py');
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'audio', 'korematsu-voiceover.mp3');

console.log('Kokoro TTS — starting generation...');
