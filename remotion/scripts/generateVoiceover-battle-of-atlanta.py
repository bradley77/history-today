...
LINES = [
    ("01", "The Battle of Atlanta didn't take Atlanta."),
    ("02", "Confederate troops broke through the Union line and captured an artillery battery."),
    ("03", "The city held out six more weeks, despite the Union victory."),
    ("04", "McPherson never got to see any of it. He was killed hours into the fight."),
    ("05", "Comment SIXWEEKS for the free Battle of Atlanta document."),
]
...
def main() -> None:
    print("=== Kokoro TTS -- battle-of-atlanta voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"battle-of-atlanta-vo-{num}.mp3"
    ...
    for num, path, sample_dur in generated:
        ...
        print(f"  battle-of-atlanta-vo-{num}.mp3  {dur:.3f}s  ->  durationInFrames: {frames}  ({dur:.3f} + {PAD}s pad x {FPS}fps)")
