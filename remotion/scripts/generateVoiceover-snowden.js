...
const PY_SCRIPT   = path.join(__dirname, 'generateVoiceover-snowden.py');
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'audio', 'snowden-voiceover.mp3');

console.log('Kokoro TTS — Snowden voiceover starting...');
