#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the McVeigh composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "mcveigh-voiceover.mp3"
...
TEXT = """
A missing license plate. That's all it took to catch him.

Timothy McVeigh. Gulf War veteran. Bronze Star recipient. The man who killed 168 Americans.

April 19th, nineteen ninety five. A truck bomb collapsed one third of a federal building. In seven seconds.

168 dead. 19 of them children in a second floor day care center.

Ninety minutes later — pulled over for no license plate. The trooper had no idea who he had.

The FBI had his face within 24 hours, connected to a Ryder rental in Junction City, Kansas.

We obtained the declassified FBI file — transmitted from Fort Riley to Oklahoma City the day after the blast.

Convicted nineteen ninety seven. Executed two thousand and one. Follow for more history they never taught you.
""".strip()
...
def main() -> None:
    print("=== Kokoro TTS — McVeigh voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src in mcveigh.js to mcveigh-voiceover.wav if using this file.")
