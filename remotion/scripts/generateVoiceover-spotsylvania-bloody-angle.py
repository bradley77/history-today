...
LINES = [
    ("spotsylvania-bloody-angle-vo-01", "Grant made a decision that cost thousands of men. This is what was left over."),
    ("spotsylvania-bloody-angle-vo-02", "Upton's column broke through in about a minute. Then it had no support, and pulled back."),
    ("spotsylvania-bloody-angle-vo-03", "Grant saw it work. He decided it needed more men."),
    ("spotsylvania-bloody-angle-vo-04", "Hancock's corps broke through again. Then the fighting concentrated at the Bloody Angle. Twenty hours, hand to hand, gunfire the whole time."),
    ("spotsylvania-bloody-angle-vo-05", "Bullets cut down this tree. Twenty-two inches of solid oak."),
]
...
def main() -> None:
    print("=== Kokoro TTS -- spotsylvania-bloody-angle voiceovers ===\n")
    ...
    for name, dur, padded, frames in frame_results:
        print(f"  {name + '.mp3':<32} {dur:>10.3f} {padded:>12.3f}")
