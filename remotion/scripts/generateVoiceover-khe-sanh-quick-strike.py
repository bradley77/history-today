...
LINES = [
    ("01", "The president forced his generals to sign a written pledge. Keh Sahn would not fall."),
    ("02", "Two hundred Marines died holding it for seventy-seven days."),
    ("03", "Four months after the siege ended, the military demolished the base and walked away. Their reason: it was no longer required."),
    ("04", "Comment RECON below for a free declassified Vietnam document."),
]
...
def main() -> None:
    print("=== Kokoro TTS — khe-sanh-quick-strike voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"khe-sanh-quick-strike-vo-{num}.mp3"
