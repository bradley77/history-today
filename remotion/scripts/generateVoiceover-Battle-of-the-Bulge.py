...
LINES = [
    ("01", "Everyone thinks Hitler caught the Allies off guard. He didn't have to. They weren't expecting a major attack."),
    ("02", "American codebreakers had read German radio for months. Then it went silent, replaced by phone and courier."),
    ("03", "Captured Germans hinted at an attack. Command dismissed the warnings. Days later, five divisions fell back."),
    ("04", "Comment FRONT for the free World War Two PDF."),
]
...
def main() -> None:
    print("=== Kokoro TTS — Battle of the Bulge voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"Battle-of-the-Bulge-vo-{num}.mp3"
