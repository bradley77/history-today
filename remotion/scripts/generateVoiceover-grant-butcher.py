"""One-off Chatterbox Turbo test generation for the grant-butcher Quick Strike.
Uses the chatterbox-env venv (see ../../test_chatterbox.py). Does not touch
the Kokoro pipeline (kokoro_pipeline.py) or any other existing script."""
