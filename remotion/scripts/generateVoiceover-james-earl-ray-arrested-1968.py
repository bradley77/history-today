#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the James Earl Ray composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "james-earl-ray-arrested-1968-voiceover.mp3"
...
TEXT = """
Congress concluded MLK's killer... probably didn't act alone.
Here's what the government never explained.

King was shot on the balcony of room three-oh-six in Memphis.
April fourth, nineteen sixty-eight.
He was thirty-nine.

The man convicted was James Earl Ray.
Escaped convict.
No money.
No passport.
No contacts abroad.

For two weeks... the FBI didn't even know his real name.
They were hunting a ghost called Eric Starvo Galt.

This is the view from where the shot was fired.
Ray crossed three countries on fake passports... with no known income.

The man who signed this was J. Edgar Hoover.
The same Hoover whose FBI wiretapped King... and sent him letters urging him to kill himself.

In nineteen seventy-nine... Congress said Ray probably didn't act alone.
A Memphis jury agreed twenty years later.

Full story and the declassified FBI file are linked in bio.
Do you think Ray acted alone?
Comment below.
And follow the page for more.
""".strip()
...
def main() -> None:
    print("=== Kokoro TTS — James Earl Ray voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src in JamesEarlRayVideo.jsx to james-earl-ray-arrested-1968-voiceover.wav if using this file.")
