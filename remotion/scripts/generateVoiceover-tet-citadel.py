...
LINES = [
    ("tet-citadel-vo-01", "Everyone knows Tet was a massive surprise attack. What gets left out is how many places it hit at once."),
    ("tet-citadel-vo-02", "In a single night, communist forces struck more than one hundred cities, towns, and military installations across South Vietnam."),
    ("tet-citadel-vo-03", "Almost everywhere, American and South Vietnamese forces threw the attacks back within days."),
    ("tet-citadel-vo-04", "Only one major city remained occupied. It took a month of street to street fighting to take it back."),
    ("tet-citadel-vo-05", "Comment CITADEL for the free declassified Vietnam document."),
]
...
def main() -> None:
    print("=== Kokoro TTS -- tet-citadel voiceovers ===\n")
