...
LINES = [
    ("01", "Seven thousand men. Seven minutes. That's the Cold Harbor story. The record tells it differently."),
    ("02", "That seven-minute figure comes from later retellings, not Grant's own report."),
    ("03", "Lee's men had days to dig in, and they used every hour."),
    # Trimmed — the standalone CTA end card (vo-05) now carries the "follow"
    # ask, so this line no longer needs to double as the closer.
    ("04", "The slaughter was real. The seven minutes weren't."),
    # Standalone CTA end card VO — no trigger word, no comment automation.
    ("05", "Follow for more history they don't teach you."),
]
...
def main() -> None:
    print("=== Kokoro TTS — Cold Harbor Quick Strike voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"cold-harbor-vo-{num}.mp3"
