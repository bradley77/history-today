#!/usr/bin/env python3
"""
Phoneme-injection pronunciation fix, round 3: Maryland, final.

Supersedes generateVoiceover-antietam-phoneme-fix-v2.py's Maryland guess
(mˈɛɹəlʌnd, "MEHR-uh-lund"). Confirmed by ear via an A/B of two standalone
single-word clips -- mˈɛɹəlʌnd vs. mˈɛɹɪlənd -- that mˈɛɹɪlənd
("MEHR-ih-luhnd") is the one that actually sounds right. Antietam's fix
(æntˈiːtəm, from round 1) is unchanged and re-applied here too, since this
regenerates slide2.mp3 in full.

  Native (still wrong): mˈɛɹɪlˌænd   (MEHR-ih-LAND)
  v2 guess (also wrong): mˈɛɹəlʌnd   (MEHR-uh-lund)
  v3, confirmed correct: mˈɛɹɪlənd   (MEHR-ih-luhnd)

On-screen captionLines text in AntietamQS.tsx is untouched -- none of this
...
SUBSTITUTIONS = [
    ("ˌæntɪˈɛɾæm", "æntˈiːtəm"),   # Antietam: an-tih-ET-am -> an-TEE-tuhm (confirmed good)
...
def main() -> None:
    print("=== Kokoro TTS -- Antietam phoneme-injection fix, round 3 (Maryland, final) ===\n")
