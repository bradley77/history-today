...
LINES = [
    ("01", "The government said the area was remote."),
    ("02", "Five days later, their own safety chief said otherwise."),
    ("03", "Fallout hit a strip of land ninety miles long. Families lived inside it."),
    ("04", "That report stayed classified for nearly eighty years."),
    ("05", "Comment FRONT to get the free World War Two fact sheet."),
]
...
def main() -> None:
    print("=== Kokoro TTS — Trinity-Test voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"Trinity-Test-vo-{num}.mp3"
