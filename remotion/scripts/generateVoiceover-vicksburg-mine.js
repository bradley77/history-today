...
const PY_SCRIPT = path.join(__dirname, 'generateVoiceover-vicksburg-mine.py');
const AUDIO_DIR = path.join(__dirname, '..', 'public', 'audio');

console.log('Kokoro TTS — vicksburg-mine voiceovers\n');
...
for (const num of slides) {
  const mp3 = path.join(AUDIO_DIR, `vicksburg-mine-vo-${num}.mp3`);
