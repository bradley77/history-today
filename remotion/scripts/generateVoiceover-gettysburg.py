#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the Gettysburg composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "gettysburg-campaign-1863-voiceover.mp3"
...
VOICE = "am_adam"    # American English male; try "af_sarah" for female
SPEED = 1.0
LANG  = "en-us"
...
TEXT = """
The deadliest battle of the Civil War didn't start at Gettysburg. It started twenty-eight days earlier. On June third, eighteen sixty-three, Robert E. Lee secretly pulled seventy-five thousand men out of Fredericksburg and aimed them north. The Union Army had no idea. He marched them through the Shenandoah Valley, a hundred miles deep into Pennsylvania. The Union was chasing ghosts. General AP Hill stayed behind, kept the fires burning, and made the Army of the Potomac think the Confederates were still in their trenches. Union scouts crossed the Rappahannock and found empty camps. Lee was already gone. He was aiming at Harrisburg. If he took the state capital, the pressure on Lincoln to end the war could have become impossible to resist. Then a scout delivered urgent news. The Union Army was closing fast. Lee ordered his forces to concentrate. They met at a crossroads town called Gettysburg. Three days. Fifty thousand casualties. It all began on June third, eighteen sixty-three.
""".strip()
...
def main() -> None:
    print("=== Kokoro TTS — Gettysburg voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src in gettysburg.js to gettysburg-campaign-1863-voiceover.wav if using this file.")
