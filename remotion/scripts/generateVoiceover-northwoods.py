#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the Operation Northwoods composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "northwoods-voiceover.mp3"
...
TEXT = """
The United States military once proposed terrorist attacks on its own citizens. This is the document that proves it.

They called it Operation Northwoods. The goal was to start a war with Cuba. To justify an invasion, they needed a pretext. So they proposed to manufacture one.

The document says it plainly. Stage terrorist attacks in Miami and Washington. Sink a boatload of Cuban refugees. Real or simulated. Those are their words, not mine.

General Lyman Lemnitzer, Chairman of the Joint Chiefs of Staff, signed it. Kennedy rejected it. Lemnitzer was quietly reassigned to Europe.

But the fact that it reached the president's desk at all is the story.

This document stayed classified for thirty-five years. This was one program. There were others.

Follow the page. Episode two drops next week.
""".strip()
...
def main() -> None:
    print("=== Kokoro TTS — Operation Northwoods voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src to northwoods-voiceover.wav if using this file.")
