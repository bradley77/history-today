...
const PY_SCRIPT   = path.join(__dirname, 'generateVoiceover-hiss.py');
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'audio', 'hiss-voiceover.mp3');

console.log('Kokoro TTS — Hiss voiceover starting...');
