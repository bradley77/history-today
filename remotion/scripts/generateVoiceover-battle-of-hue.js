...
const PY_SCRIPT = path.join(__dirname, 'generateVoiceover-battle-of-hue.py');
const AUDIO_DIR = path.join(__dirname, '..', 'public', 'audio');

console.log('Kokoro TTS — battle-of-hue voiceovers\n');
...
for (const num of slides) {
  const mp3 = path.join(AUDIO_DIR, `battle-of-hue-vo-${num}.mp3`);
