...
LINES = [
    ("slide-1", "Fifty-six men raided a prison in enemy territory and found it empty. Every man came home."),
    ("slide-2", "Green Berets crash-landed inside Son Tay prison to free American POWs."),
    ("slide-3", "The prisoners had already been moved. Raiders fought through dozens of armed troops to clear the compound."),
    ("slide-4", "Two injuries. No one was killed. It remains one of the most precisely executed raids in American military history."),
    ("cta", "Comment RECON for the free Vietnam document."),
]
...
def main() -> None:
    print("=== Kokoro TTS — son-tay voiceovers ===\n")
    ...
    for name, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"son-tay-{name}.mp3"
