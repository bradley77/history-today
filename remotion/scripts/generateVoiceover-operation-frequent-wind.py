...
LINES = [
    ("01", "He destroyed ten million dollars, on purpose."),
    ("02", "Twenty-six helicopters had already landed. There was nowhere to land."),
    ("03", "Then a tiny two-seat plane appeared: a pilot, his wife, five kids, nearly out of fuel."),
    ("04", "He'd never landed on a carrier before. He made it. All seven survived."),
    ("05", "Comment RECON to get the free Vietnam fact sheet."),
]
...
def main() -> None:
    print("=== Kokoro TTS — operation-frequent-wind voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"operation-frequent-wind-vo-{num}.mp3"
