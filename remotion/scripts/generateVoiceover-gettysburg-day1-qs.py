...
AUDIO_DIR   = REPO_ROOT / "public" / "audio" / "gettysburg-day1-qs"
...
LINES = [
    ("01", "This man won Day One at Gettysburg. The Union army didn't know it yet — because at that moment, they were fleeing through the streets of the town."),
    ("02", "Nine thousand Union casualties in a single afternoon. Routed north and west of town, they broke and ran. But they ran uphill."),
    ("03", "To Cemetery Hill — the strongest ground on the battlefield. Confederates held the town, Union held the high ground. Buford bought the time that let them take it."),
    ("04", "Day Two at Gettysburg — tomorrow."),
]
...
def main() -> None:
    print("=== Kokoro TTS — gettysburg-day1-qs voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"gettysburg-day1-qs-vo-{num}.mp3"
