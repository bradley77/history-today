...
const PY_SCRIPT   = path.join(__dirname, 'generateVoiceover-battle-of-midway.py');
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'audio', 'battle-of-midway-voiceover.mp3');

console.log('Kokoro TTS — Battle of Midway voiceover starting...');
