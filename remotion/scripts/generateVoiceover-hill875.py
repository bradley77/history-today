...
LINES = [
    ("01", "This hill had no name. Only a number. Hill eight seven five."),
    ("02", "Paratroopers of the one seventy third Airborne dug in below the summit, waiting for orders to move up."),
    ("03", "When they went up, North Vietnamese troops were dug into bunkers that had largely survived the artillery and airstrikes."),
    ("04", "The fight for this hill cost the one seventy third Airborne Brigade a fifth of its strength. And United States forces walked away."),
]
...
def main() -> None:
    print("=== Kokoro TTS — hill875 voiceovers ===\n")
    ...
    # Pass one or more slide numbers as CLI args to regenerate only those
    # (e.g. `python generateVoiceover-hill875.py 04`) — same convention as
    # generateVoiceover-guadalcanal.py/generateVoiceover-maryesangel.py.
    # With no args, regenerates every slide.
    ...
    for num, text in lines:
        ...
        mp3_path = AUDIO_DIR / f"hill875-vo-{num}.mp3"
