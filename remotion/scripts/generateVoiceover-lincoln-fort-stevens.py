...
LINES = [
    ("slide1", "Confederate troops got within five miles of the United States Capitol."),
    ("slide2", "Lincoln rode out to watch. He stood on the parapet in plain sight of enemy snipers."),
    ("slide3", "The man standing next to him was shot."),
]
...
def main() -> None:
    print("=== Kokoro TTS — lincoln-fort-stevens voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"lincoln-fort-stevens-{num}.mp3"
