#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the Hiss composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "hiss-voiceover.mp3"
...
A State Department insider.

He helped write the charter for the United Nations.

His name was Alger Hiss.

And the U.S. government said he was a Soviet spy.

A man named Whittaker Chambers accused him publicly.
Nobody believed it.
Chambers was a former communist. A nobody.
Hiss was untouchable.

Then investigators followed Chambers to a farm in Maryland.
...
A young congressman named Richard Nixon
made his entire career off what came next.

Alger Hiss went to prison.
He never confessed.
He said he was innocent until the day he died.
...
def main() -> None:
    print("=== Kokoro TTS — Hiss voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src in hiss.js to hiss-voiceover.wav if using this file.")
