...
LINES = [
    ("1", "One strike turned it into a one-sided slaughter. Marine Corps jets boxed in both ends with cluster bombs."),
    ("2", "For ten hours, aircraft hit everything trapped in between."),
    ("3", "The death toll is still disputed. President Bush called a ceasefire the next day."),
    ("4", "Comment HIGHWAY80 and I'll send you the free document."),
]
...
def main() -> None:
    print("=== Kokoro TTS — highway-of-death voiceovers ===\n")
    ...
    for num, text in LINES:
        ...
        mp3_path = AUDIO_DIR / f"highway-of-death-slide{num}-voiceover.mp3"
