#!/usr/bin/env python3
"""
Kokoro TTS voiceover generator for the Madison composition.
...
OUTPUT_FILE = REPO_ROOT / "public" / "audio" / "madison-voiceover.mp3"
...
TEXT = """
The last time a US president followed the Constitution on war. Eighteen twelve.

British warships were stopping American vessels on the open ocean. Dragging sailors off the deck. Forcing them into the Royal Navy.

Thousands of American citizens. Taken. No trial. No warning. Just gone.

On June 1, 1812, President James Madison sat down and wrote Congress a letter.

He laid out every grievance. Every violation. And then he did something no president has done since.

He asked permission.

Congress voted yes. Seventy-nine to forty-nine. Seventeen days later, America was at war.

The British burned Washington to the ground. Why did presidents stop asking? Link in bio.
""".strip()
...
def main() -> None:
    print("=== Kokoro TTS — Madison voiceover ===\n")
    ...
    if FFMPEG.exists():
        ...
        print("Update the audio src in MadisonVideo.jsx to madison-voiceover.wav if using this file.")
