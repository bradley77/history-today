...
const PY_SCRIPT   = path.join(__dirname, 'generateVoiceover-northwoods.py');
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'audio', 'northwoods-voiceover.mp3');

console.log('Kokoro TTS — Operation Northwoods voiceover starting...');
