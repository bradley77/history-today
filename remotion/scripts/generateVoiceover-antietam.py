...
LINES = [
    ("slide1", "You have the wrong bloodiest day."),
...
def main() -> None:
    print("=== Kokoro TTS -- Antietam BLUEGRAY Quick Strike voiceovers ===\n")
    ...
    for name, path, sample_dur in generated:
        ...
        print(f"  {name}.mp3  {dur:.3f}s  ->  durationInSeconds: {padded:.3f}  ->  durationInFrames: {frames}  ({dur:.3f} + {PAD}s pad x {FPS}fps)")
