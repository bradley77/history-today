...
const PY_SCRIPT = path.join(__dirname, 'generateVoiceover-Trinity-Test.py');
const AUDIO_DIR = path.join(__dirname, '..', 'public', 'audio');

console.log('Kokoro TTS — Trinity-Test voiceovers\n');
...
for (const num of slides) {
  const mp3 = path.join(AUDIO_DIR, `Trinity-Test-vo-${num}.mp3`);
